...
export function CreateSponsorDialog({ children }: { children: React.ReactNode }) {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    try {
      await createDocumentWithImage("sponsors", {
        name: values.title,
      }, values.file)
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>Add a new sponsor logo to your dashboard.</DialogDescription>
        </DialogHeader>
        <Form {...form}>
