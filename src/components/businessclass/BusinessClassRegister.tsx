            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="mt-2">
                    <label className="block text-sm font-medium text-gray-300 mb-3">Select The Class Level You Want To Participate In</label>
                    <RadioGroup 
          ...
          {currentStep === 2 && (
            <div className="space-y-6">
              <div>
                ...
                <div className="space-y-4">
                  <div>
                    <label className="block text-sm font-medium text-gray-300 mb-1">Reason for joining HIPMI UI Business Class. <br></br>If you have a business, write down your business's name, social media, and division.</label>
                    <Textarea
